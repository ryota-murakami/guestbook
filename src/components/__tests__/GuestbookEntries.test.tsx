...
describe('GuestbookEntries', () => {
  ...
  it('should render loading state when loading and no initial entries', () => {
    ...
    const { getByText } = render(<GuestbookEntries initialEntries={[]} />)
  ...
  it('should render error state when there is an error', () => {
    ...
    expect(
      getByText('Error loading entries: Failed to fetch'),
    ).toBeInTheDocument()
  ...
  it('should render empty state when there are no entries', () => {
    ...
    expect(
      getByText('No entries yet. Be the first to sign the guestbook!'),
    ).toBeInTheDocument()
  })
})
